...
function init_gear_sets()
    ...
    sets.idle = {
        ...
        body="Royal Cloak",hands="Cpc. Gauntlets +1",ring1="Merman's Ring", ring2="Merman's Ring",
        back="Lamia Mantle +1",waist="Scouter's Rope",legs="Feral Trousers",feet="Feral Ledelsens"}
    ...
    sets.engaged = {ammo="Fire Bomblet",
		...
		body="Antares Harness",hands="Dusk Gloves +1",ring1="Flame Ring",ring2="Flame Ring",
		back="Cerb. Mantle +1",waist="Velocious Belt",legs="Dusk Trousers +1",feet="Dusk Ledelsens +1"}
	sets.engaged.DT = {ammo="Aqreqaq Bomblet",
        head="Futhark Bandeau +1",neck="Twilight Torque",ear1="Ethereal Earring",ear2="Genmei Earring",
		body="Futhark Coat +1",hands="Denali Wristbands",ring1="Succor Ring",ring2="Defending Ring",
		back="Evasionist's Cape",waist="Kentarch Belt +1",legs=gear.DT_legs,feet="Herculean Boots"}
	sets.engaged.Evasion = {}
	sets.latent_hp75 = {neck="Orochi Nodowa", body="Dusk Jerkin"}
end
