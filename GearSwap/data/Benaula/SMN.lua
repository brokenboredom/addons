...
function init_gear_sets()
	...
	sets.midcast['Summoning Magic'] = {
		head="Evoker's Horn", --+5 smn
		hands="Smn. Bracers +1", --+12 smn
		ring1="Evoker's Ring", --+10 smn
		neck="Smn. Torque", --+7 smn
	}
    ...
    sets.midcast.Pet.PhysicalBloodPactRage = sets.midcast.Pet.Skill

    sets.midcast.Pet.PhysicalBloodPactRage.Acc = sets.midcast.Pet.Skill
	...
	--enfeebling
	sets.midcast['Enfeebling Magic'] = sets.midcast.int
    ...
    sets.perp.Day = {body="Smn. Doublet +1"}
