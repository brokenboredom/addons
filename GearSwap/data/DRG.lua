...
function init_gear_sets()
	...
	--Default
	sets.precast.WS = {
		head="Ace's Helm",neck="Chivalrous Chain",ear1="Merman's Earring",ear2="Merman's Earring",
		body="Scp. Harness +1",hands="Dusk Gloves +1",ring1="Flame Ring",ring2="Flame Ring",
		back="Amemet Mantle +1",waist="Potent Belt",legs="Askar Dirs",feet="Mercenary's Boots"}
	...
	sets.midcast.HB = {head="Wyrm Armet"}
	...
	sets.engaged.Normal = {
		head="Ace's Helm",neck="Chivalrous Chain",ear1="Merman's Earring",ear2="Merman's Earring",
		body="Scp. Harness +1",hands="Dusk Gloves +1",ring1="Flame Ring",ring2="Thunder Ring",
		back="Amemet Mantle +1",waist="Velocious Belt",legs="Askar Dirs",feet="Dusk Ledelsens +1"}
	...
	sets.idle.Normal = {
		...
		body="Scp. Harness +1",hands="Cpc. Gauntlets +1",ring1="Merman's Ring",ring2="Merman's Ring",
		back="Amemet Mantle +1",waist="Velocious Belt",legs="Askar Dirs",feet="Mercenary's Boots"}
