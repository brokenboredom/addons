...
function init_gear_sets()
    ...
    sets.idle = {ammo="Impatiens",
        ...
        body="Hagondes Coat",hands="Magical Mitts",ring1="Sheltered Ring",ring2="Paguroidea Ring",
    ...
    -- Normal melee group
    sets.engaged = {
        head="Atrophy Chapeau +1",neck="Ajase Beads",ear1="Suppanomimi",ear2="Brutal Earring",
        body="Atrophy Tabard +1",hands="Dusk Gloves",ring1="Rajas Ring",ring2="K'ayres Ring",
        back="Amemet Mantle +1",waist="Velocious Belt",legs="Osmium Cuisses",feet="Atrophy Boots"}
