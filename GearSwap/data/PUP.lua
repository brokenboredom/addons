...
function init_gear_sets()
    ...
    sets.precast.JA['Repair'] = {feet="Pup. Babouches +1"}

    sets.precast.JA.Maneuver = {neck="Buffoon's Collar",hands="Pup. Dastanas +1"}
    ...
    sets.precast.Waltz = {
        ...
        hands="Pantin Dastanas +1",ring2="Bastokan Ring",
        back="Prism Cape",legs="Pup. Churidars",feet="Goliard Clogs"}
    ...
    sets.precast.WS = {
        head="Pantin Taj +1",neck="Fotia Gorget",ear1="Pixie Earring",ear2="Brutal Earring",
        body="Pantin Tobe +1",hands="Pup. Dastanas +1",ring1="Rajas Ring",ring2="Mars's Ring",
        back="Pantine Cape",waist="Potent Belt",legs="Ptn. Churidars +1",feet="Pup. Babouches +1"}
    ...
    sets.midcast.Pet['Elemental Magic'] = {feet="Ptn. Babouches +1"}
    ...
    -- Idle sets
    sets.idle = {
        head="Pantin Taj +1",neck="Orochi Nodowa",ear1="Merman's Earring",ear2="Merman's Earring",
        body="Goliard Saio",hands="Pup. Dastanas +1",ring1="Merman's Ring",ring2="Merman's Ring",
        back="Umbra Cape",waist="Ninurta's Sash",legs="Goliard Trews",feet="Pup. Babouches +1"}
    ...
    -- Normal melee group
    sets.engaged = {
        head="Acubens Helm",neck="Chivalrous Chain",ear1="Pixie Earring",ear2="Brutal Earring",
        body="Goliard Saio",hands="Pantin Dastanas +1",ring1="Rajas Ring",ring2="Mars's Ring",
        back="Pantin Cape",waist="Ninurta's Sash",legs="Ptn. Churidars +1",feet="Pup. Babouches +1"}
