...
function user_setup()
    state.OffenseMode:options('Normal', 'DW', 'Acc')
    state.PhysicalDefenseMode:options('PDT', 'MDT', 'Killer')
...
function init_gear_sets()
    ...
    sets.precast.WS = {
		head="Hecatomb Cap +1",neck="Fotia Gorget",ear1="Pixie Earring",ear2="Merman's Earring",
		body="Adaman Hauberk",hands="Skadi's Bazubands",ring1="Rajas Ring",ring2="Crimson Ring",
    ...
    sets.idle = {
		...
		body="Merman's Harness",hands="Askar Manopolas",ring1="Merman's Ring",ring2="Shadow Ring",
		back="Boxer's Mantle",waist="Scouter's Rope",legs="Merman's Subligar",feet="Skadi's Jambeaux"}
    ...
    sets.engaged.Acc = {
		head="Askar Zucchetto",neck="Peacock Amulet",ear1="Pixie Earring",ear2="Brutal Earring",
		body="Adaman Hauberk",hands="Dusk Gloves +1",ring1="Rajas Ring",ring2="Sniper's Ring +1",
		back="Amemet Mantle +1",waist="Potent Belt",legs="Byakko's Haidate",feet="Dusk Ledelsens +1"}
